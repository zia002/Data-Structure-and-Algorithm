...
//------------------------------------------------------------------
//Delete--Node--at--any---point--of-Doubly-Circular---Linked---List:
//-----------------------------------------------------------------
void anypoint()
{
...
//--------------------------------------------------------------------
//Delete--Node--at--start---point--of--Doubly-Circular---Linked---List:
//--------------------------------------------------------------------
void startpoint()
{
    if(head==tail)
...
//-------------------------------------------------------------------
//Delete--Node--at--end---point--of--Doubly--Circular---Linked---List:
//--------------------------------------------------------------------
void endpoint()
{
    if(head==tail)
